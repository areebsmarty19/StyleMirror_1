...
public class activity_shoes_list extends AppCompatActivity {
    ...
    private void itemlistRecyclerView() {
        ...
        items.add(new PopularDomain(6,"NIKE Mens Full Force LoRunning Shoe","shoess_6_1","shoess_6_2","shoess_6_3",3.8,8,5947,"NIKE FULL FORCE LO-WHITE/MYSTIC RED-BLACK-SAIL-FB1362-102-7UK","https://www.amazon.in/dp/B0CLYVZMNZ?starsLeft=1&ref_=cm_sw_r_ud_dp_ASNF7F2D38MPMRRR4AHK"));
