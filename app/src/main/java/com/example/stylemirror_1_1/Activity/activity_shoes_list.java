...
public class activity_shoes_list extends AppCompatActivity {
    ...
    private void itemlistRecyclerView() {
        ...
        items.add(new PopularDomain(1,"Air Max 270 Sneakers","shoes2",10,4,9796,"Wipe with clean cloth Nike's first lifestyle \n"+
        ...
        items.add(new PopularDomain(2,"Nike Viale Premium Men's Running Shoes","shoes6",0,0,5695,"Nike Viale Premium Men's Running Shoes\n" +
                "NIKE men's running shoes\n"));
        items.add(new PopularDomain(3,"TRENDUTY Canvas Shoes for men","shoes1",15,4.1,852,"Allow your pair of shoes to air and de-odorize at\n"+
        ...
        items.add(new PopularDomain(4,"AIR ZOOM PEGASUS 36 Running","shoes3",5,4.3,3000,"Nike Air Zoom Pegasus 36-Men's\n"+
        ...
        items.add(new PopularDomain(5,"NIKE Men's Air Max 90 Running Shoe","shoes4",0,0,11890,"Wipe with clean cloth Nike's first lifestyle \n"+
                "Air Max brings you style, comfort and big \n"+
                "attitude in the Nike Air Max 270. The design \n"+
                "draws inspiration from Air Max icons, showcasing\n"+
                "Nike's greatest innovation with its large window\n"+
                "and fresh array of colours."));
        items.add(new PopularDomain(6,"Jordan 1 Retro High OG Bordeaux Men's Basketball 555088-611","shoes5",30,4.5,50828,"The Air Jordan 1 High OG Rebellionaire is a unique colorway of\n"+
