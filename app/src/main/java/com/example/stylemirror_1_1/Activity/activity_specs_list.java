...
public class activity_specs_list extends AppCompatActivity {
    ...
    private void itemlistRecyclerView() {
        ...
        items.add(new PopularDomain(15,"UV Protection Over-sized Sunglasses","spects_5_1","spects_5_2","spects_5_3",0,0,499,"Size" + "This product is sold as Medium by the Brand" + "Ideal For" + "Men & Women" + "Purpose" + "Eye Protection" + "Lens Color and Material" + "Blue, Polycarbonate" + "Features" + "UV Protection" + "Frame Color" + "SILVER" + "Type" + "Over-sized" + "Style Code" + "RD-302-C1.","https://www.flipkart.com/roadies-over-sized-sunglasses/p/itm64baf95355cf8?pid=SGLGCQXV4VHFYJU6&cmpid=product.share.pp&_refId=PP.bb17b692-b946-4e7d-bfc3-b36da09e6fe9.SGLGCQXV4VHFYJU6&_appId=WA"));
        items.add(new PopularDomain(16,"John Jacobs Brown Browline Polarized and UV Protected Sunglasses","spects_6_1","spects_6_2","spects_6_3",4.1,6,2807,"Material Composition UV protected Tortoise Golden Brown Solid Full Rim Browline John Jacobs JJ Tints JJ S13088-C2 Sunglasses" + "Polarized and 100% UV Protection (UV 400), Anti-Glare, Anti-Refraction" + "Ideal For Men & Women | Size: Large" + "Frame Material: Stainless Steel | Lens Material: Polycarbonate","https://www.amazon.in/dp/B08YNRMZG7?starsLeft=1&ref_=cm_sw_r_ud_dp_3X17N14C1KJJX775HYGW"));
        items.add(new PopularDomain(17,"UV Protection Aviator Sunglasses","spects_7_1","spects_7_2","spects_7_3",0,0,1274,"Size " + "This product is sold as Small by the Brand " + "Ideal For " + "Men " + "Purpose " + "Running " + "Lens Color and Material " + "Black, Plastic " + "Features " + "UV Protection " + "Frame Color " + "Silver " + "Model Name " + "Velocity Full Rim Aviator Shape Sunglass " + "Type " + "Aviator","https://www.flipkart.com/speksee-aviator-sunglasses/p/itm578b54233f383?pid=SGLGUE8U4ABQVH5Y&cmpid=product.share.pp&_refId=PP.306a0ee9-796a-457d-a55a-aee80e38ff9f.SGLGUE8U4ABQVH5Y&_appId=WA"));
