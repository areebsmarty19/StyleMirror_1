...
public class activity_specs_list extends AppCompatActivity {
    ...
    private void itemlistRecyclerView() {
        ...
        items.add(new PopularDomain(13,"Ray-Ban Rb3447 Round Metal Sunglasses","spects_3","spects_3_2","spects_3_3",4.1,103,0,"Timeless Ray-Ban Round sunglasses feature retro round metal frames, a look worn by legendary musicians and inspired by 1960s counter-culture Round shape, matte gold metal frame, fixed crystal green polarized lenses that make these frames look real Featuring an iconic G-15 lens engineered to give you the clearest and most natural vision absorbing 85% of visible light and blocking most blue light, it delivers remarkable color contrast and visual clarity.","https://www.amazon.in/dp/B00UO05CY0?starsLeft=1&ref_=cm_sw_r_ud_dp_8E4FN75F8CGVDD2CQ7E4"));
        items.add(new PopularDomain(14,"UV Protected Unisex Sunglasses","spects_4","spects_4_2","spects_4_3",5,1,348,"A perfect blend of highly durable modern day materials styled with pure craftsmanship and the trust of thousands of customers.","https://www.amazon.in/dp/B0C4FBCJWC?starsLeft=1&ref_=cm_sw_r_ud_dp_K4CZRY9CVC6JAWEXRZ72"));
        items.add(new PopularDomain(15,"UV Protection Over-sized Sunglasses","spects_5","spects_5_2","spects_5_3",0,0,499,"Size" + "This product is sold as Medium by the Brand" + "Ideal For" + "Men & Women" + "Purpose" + "Eye Protection" + "Lens Color and Material" + "Blue, Polycarbonate" + "Features" + "UV Protection" + "Frame Color" + "SILVER" + "Type" + "Over-sized" + "Style Code" + "RD-302-C1.","https://www.flipkart.com/roadies-over-sized-sunglasses/p/itm64baf95355cf8?pid=SGLGCQXV4VHFYJU6&cmpid=product.share.pp&_refId=PP.bb17b692-b946-4e7d-bfc3-b36da09e6fe9.SGLGCQXV4VHFYJU6&_appId=WA"));
        items.add(new PopularDomain(16,"John Jacobs Brown Browline Polarized and UV Protected Sunglasses","spects_6","spects_6_2","spects_6_3",4.1,6,2807,"Material Composition UV protected Tortoise Golden Brown Solid Full Rim Browline John Jacobs JJ Tints JJ S13088-C2 Sunglasses" + "Polarized and 100% UV Protection (UV 400), Anti-Glare, Anti-Refraction" + "Ideal For Men & Women | Size: Large" + "Frame Material: Stainless Steel | Lens Material: Polycarbonate","https://www.amazon.in/dp/B08YNRMZG7?starsLeft=1&ref_=cm_sw_r_ud_dp_3X17N14C1KJJX775HYGW"));
        ...
        items.add(new PopularDomain(19,"UV Protection Cat-eye Sunglasses","spects_9","spects_9_2","spects_9_3",0,22,404, "Size " + "This product is sold as Free Size by the Brand " + "Ideal For " + "Women " + "Purpose " + "Style, Driving, Biking " + "Lens Color and Material " + "Silver, TAC Resin " + "Features " + "UV Protection " + "Frame Color " + "Golden " + "Type " + "Cat-eye " + "Style Code " + "Cat Eye Sunglasses for Women, Metal Frame Mirrored Lenses Fashion Sunglass","https://www.flipkart.com/jubilant-cat-eye-sunglasses/p/itm3de4bc213dbfa?pid=SGLG4GASS8MGUYHA&cmpid=product.share.pp&_refId=PP.1e1c2780-ba16-4b2d-8028-feade848aaca.SGLG4GASS8MGUYHA&_appId=WA"));
